function  [ll, ff_throat]  = BldTPoly( dd,nn,NN,hb,rr,InVal,Del_x,...
                                        Gamma,Tot_Int_Pts,...
...
ll = zeros(dd,rmaxp1,Tot_Int_Pts,NN);   
...
for j = 1:NN
    ...
    ll(:,:,:,j) = mat;   % transfer Taylor polys coeffs for each component
