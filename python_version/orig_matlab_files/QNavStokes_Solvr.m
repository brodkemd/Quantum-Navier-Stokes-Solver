function [ z ] = QNavStokes_Solvr( a, Tot_TSteps, in_n, d, r,err1, ...
...
%   quantities scaled appropriately and so are dimensionless.
%
...
[Del_x, A, Mach_E, Mrho_E, Press_E, Temp_E, Vel_E, ...
    InitVal, n, N, t, hbar, Tot_Int_Pts, U2_in, delta1, k, ithroat, ...
    ff0_throat_in, ff1_throat_in, ff2_throat_in] = ...
...
[U2, Mach_D, Mrho_D, Press_D, Temp_D, Vel_D, Rel_MachErr, ...
  ...
  Rel_VelErr
  AvRelTempErr
  AvPlusSDevRelTempErr
  AvMinusSDevRelTempErr
  AvRelMachErr
  AvPlusSDevRelMachErr
  AvMinusSDevRelMachErr
  AvRelMrhoErr
  AvPlusSDevRelMrhoErr
  AvMinusSDevRelMrhoErr
  AvRelPressErr
  AvPlusSDevRelPressErr
...
WriteResults(n, Tot_X_Pts, d, U2, Mach_D, Mach_E, Mrho_D, Mrho_E,...
             Press_D, Press_E, Temp_D, Temp_E, Rel_MachErr,...
             Rel_MrhoErr, Rel_PressErr, Rel_TempErr, ...
             AvRelTempErr, AvPlusSDevRelTempErr, AvMinusSDevRelTempErr,...
             AvRelMachErr, AvPlusSDevRelMachErr, AvMinusSDevRelMachErr,...
             AvRelMrhoErr, AvPlusSDevRelMrhoErr, AvMinusSDevRelMrhoErr,...
          AvRelPressErr, AvPlusSDevRelPressErr, AvMinusSDevRelPressErr,...
...
disp(['Program runtime per subinterval(minutes) = ' ...
                      num2str(timepersubint)])
