function [U, Delta_t,In_Mass_Flow] = SetInCond(Shock_Flag,...
                        In_Mass_Flow_E,Gamma,x,...
                            Del_x,A,d,Mrho_E,Temp_E, ...
                             ICMFlowErrScale, ICrhoErrScale,ICtempErrScale)
